...
describe('Query', () => {
  ...
  it('Check non-merklized query', async () => {
    const query: Query = {
      allowedIssuers: ['*'],
      credentialSubject: {
  ...
  it('Selective disclosure with xsd:string type', async () => {
    const query: Query = {
      allowedIssuers: ['*'],
      credentialSubject: {
        position: {}
  ...
  it('EQ operator for xsd:string type', async () => {
    const query: Query = {
      allowedIssuers: ['*'],
      credentialSubject: {
        position: {
  ...
  it('Empty disclosure JSON for disclosure request', async () => {
    const query: Query = {
      allowedIssuers: ['*'],
      credentialSubject: {
        countryCode: {}
  ...
  it('Not EQ operation for disclosure request', async () => {
    const query: Query = {
      allowedIssuers: ['*'],
      credentialSubject: {
        countryCode: {}
  ...
  it('Not array of values for disclosure request', async () => {
    const query: Query = {
      allowedIssuers: ['*'],
      credentialSubject: {
        countryCode: {}
  ...
  it('Proof was generated for another disclosure value', async () => {
    const query: Query = {
      allowedIssuers: ['*'],
      credentialSubject: {
        countryCode: {}
  ...
  it('Different key between proof and disclosure response', async () => {
    const query: Query = {
      allowedIssuers: ['*'],
      credentialSubject: {
        documentType: {}
  ...
  it('Multiple predicates in one request', async () => {
    const query: Query = {
      allowedIssuers: [issuerDID],
      credentialSubject: {
        countryCode: {
  ...
  it('Proof was generated for another query operator', async () => {
    const query: Query = {
      allowedIssuers: [issuerDID],
      credentialSubject: {
        countryCode: {
  ...
  it('failed to validate operators: comparison value that was used is not equal to requested in query', async () => {
    const query: Query = {
      allowedIssuers: [issuerDID],
      credentialSubject: {
        countryCode: {
  ...
  it('Check revocation is required', async () => {
    const query: Query = {
      allowedIssuers: [issuerDID],
      credentialSubject: {
        countryCode: {
  ...
  it('Unsupported lt operator for xsd:boolean', async () => {
    const query: Query = {
      allowedIssuers: [issuerDID],
      credentialSubject: {
        ZKPexperiance: {
  ...
  it('Negative value in request', async () => {
    const query: Query = {
      allowedIssuers: [issuerDID],
      credentialSubject: {
        documentType: {
  ...
  it('Generated proof is outdated', async () => {
