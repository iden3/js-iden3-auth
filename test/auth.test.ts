...
describe('auth tests', () => {
  ...
  it('TestFullVerify - Auth V3', async () => {
    const sender = 'did:iden3:polygon:amoy:x9X6FKAKt4gaPFHH72LCRMgsDH5JF65ndfFnQjBXz';
    const callback = 'https://test.com/callback';
    const reason = 'age verification';
  ...
  it('TestFullVerify StableV3', async () => {
    ...
    const proofRequestAge: ZeroKnowledgeProofRequest = {
      id: 1,
    ...
    const proofRequestEmployeeLinked: ZeroKnowledgeProofRequest = {
      id: 2,
    ...
    const proofRequestEmployee: ZeroKnowledgeProofRequest = {
      id: 3,
      circuitId: CircuitId.AtomicQueryV3Stable,
      optional: opt,
      query: {
    ...
    request.body.scope.push(proofRequestAge, proofRequestEmployeeLinked, proofRequestEmployee);

    request.id = '28494007-9c49-4f1a-9694-7700c08865bf';
    request.thid = 'ee92ab12-2671-457e-aa5e-8158c205a985';

    const token = `eyJhbGciOiJncm90aDE2IiwiY2lyY3VpdElkIjoiYXV0aFYyIiwiY3JpdCI6WyJjaXJjdWl0SWQiXSwidHlwIjoiYXBwbGljYXRpb24vaWRlbjMtemtwLWpzb24ifQ..`;
    ...
    const circuitsUsed = response.body.scope.map((scope) => scope.circuitId);
    expect(circuitsUsed).toEqual([
