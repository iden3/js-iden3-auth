...
export class DID {
  ...
  constructor(idStr: string, blockchain?: Blockchain, networkId?: NetworkId) {
  ...
  static parseDid(didStr: string) {
    ...
    switch (parts.length) {
        ...
        case 5:    
            ...
            return new DID(Id.idFromString(parts[4]).string(),parts[2] as Blockchain, parts[3] as NetworkId );
        default:
